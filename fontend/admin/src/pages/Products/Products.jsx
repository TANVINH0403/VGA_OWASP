...
const Products = () => {
  ...
  const getImageUrl = (imgUrl) => {
    ...
    // Image
    if (imgUrl.startsWith('/images/')) return `http://localhost:4175${imgUrl}`;
                    ...
                    <td>
                      {getImageUrl(p.imgUrl || p.imageUrl) ? (
                        <img 
                          ...
                          onError={(e) => { e.target.onerror = null; e.target.src = 'http://localhost:4175/images/products/gpu_original.png'; }}
                        />
                      ) : (
